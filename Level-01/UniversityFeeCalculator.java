...
public class UniversityFeeCalculator {
	public static void main(String args[]) {
		// Defining the fee of the student
		double fee = 125000;
		// Defining the discount percentage
		double discountPercent = 10;
		// calculating the discount
		double discountAmount = fee * discountPercent / 100;
		// calculating the fee that student need to pay
		double finalDiscountedFee = (fee - discountAmount);
		// printing the output
		System.out.println(
				"The discount amount is INR " + discountAmount + " and final discounted fee is INR " + finalDiscountedFee);
